    ...
    return (
        <>
            <div className="container your-bike">
                ...
                <YourParts key={targetWheels?.id} id={targetWheels?.id}  image={targetWheels?.image} link={targetWheels?.link} title={targetWheels?.title} part="wheels" next={handleNext} back={handleBack}/>
                </div>
            </div>
        </>
    );
